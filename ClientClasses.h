...
Данный файл содержит в себе определения основных классов, используемых в программе, и некоторых переменных,
которые должны быть видимы во всей программе
*/
...
/*! \brief Вектор для хранения списка сообщений в чате.
